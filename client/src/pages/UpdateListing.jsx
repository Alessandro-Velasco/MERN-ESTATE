  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
     ...
     <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
      <div className='flex flex-col gap-4 flex-1'>
       ...
       <input type="text" placeholder='Name' className='border p-3 rounded-lg' id='name' maxLength='1000' minLength='10' required onChange={handleChange} value={formData.name} />
       ...
       <div className='flex flex-col intems-centerl'>
        ...
        <div className='flex items-center gap-2'>
            <input type="number" id='regularPrice' min='50' max='10000000' required className='p-3 border border-gray-300 rounded-lg' onChange={handleChange} 
        ...
        {formData.offer && (
            <div className='flex items-center gap-2'>
            <input type="number" id='discountPrice' min='0' max='10000000' required className='p-3 border border-gray-300 rounded-lg' onChange={handleChange} 
    ...
    <div className='flex flex-col flex-1 gap-4'>
      ...
      <div className='flex-gap-4'>
        ...
        <button type='button' disabled={uploading} onClick={handleImageSubmit} className='p-3 text-green-700 border rounded uppercase hover:shadow-lg disable:opacity-80'>{uploading ? 'Uploading...' : 'Upload'}</button>
      </div>
      <p className='text-red-700 text-sm' text>{imageUploadError && imageUploadError}</p>
      {
